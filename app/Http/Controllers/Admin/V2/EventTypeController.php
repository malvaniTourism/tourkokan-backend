...
{
    /**
     * Event types dropdown for admin.
     * POST /v2/eventTypeDD  (admin)
     *
     ...
     *   status      – boolean, filter active/inactive (admin only)
     */
    public function index(Request $request)
    {
        ...
        try {
            ...
            $types = $query->orderBy('name')
                ->get(['id', 'parent_id', 'name', 'mr_name', 'code', 'icon', 'is_hot_type', 'status']);
